 ...
 *
 * The followings are the available columns in table 'tb_kota':
 * @property string $id
 * @property integer $provinsi_id
 * @property string $nama
 */
class TbKota extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return TbKota the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, provinsi_id, nama', 'safe', 'on'=>'search'),
		);
	}
