 ...
 */
class MaterialDescription extends CActiveRecord
{
	/**
	...
	{
		return 'pg_material_description';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('subcontent', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, language_id, title, content, subcontent', 'safe', 'on'=>'search'),
		);
	}
