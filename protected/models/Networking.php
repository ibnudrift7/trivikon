...
/**
 * This is the model class for table "networking".
 *
 * The followings are the available columns in table 'networking':
 * @property integer $id
 * @property string $image
 * @property string $url
 */
class Networking extends CActiveRecord
{
	/**
	 ...
	 * @return Networking the static model class
	 */
