        ...
        <div class="headerinner">
            <ul class="headmenu">
                <li style="border-right: 0px;">
                    <a style="visibility: hidden;" class="dropdown-toggle" href="<?php echo CHtml::normalizeUrl(array('/admin/customer/index')); ?>">
                    <span class="head-icon fa fa-tag"></span>
                    <span class="headmenu-label"><?php echo Tt::t('admin', 'Member') ?></span>
                    </a>
                </li>
                <?php /*
                <li >
                ...
                <?php endif ?>
                <li >
                    <a class="dropdown-toggle" href="<?php echo CHtml::normalizeUrl(array('/admin/blog/index')); ?>">
                    <span class="head-icon fa fa-inbox"></span>
                    <span class="headmenu-label"><?php echo Tt::t('admin', 'Events') ?></span>
                    </a>
                </li>
                */ ?>
                <li class="right">
