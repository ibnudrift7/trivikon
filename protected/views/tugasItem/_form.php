...
<div class="widgetcontent">
	...
	<?php echo $form->textFieldRow($model,'dari',array('class'=>'span5 form-control')); ?>
	<?php 
	...
	?>
	<?php echo $form->dropDownListRow($model,'kepada', $members_dn, array('class'=>'span5 form-control','empty'=>'Pilih Member')); ?>
	...
	<?php if ($model->scenario == 'update'): ?>
		<?php echo $form->dropDownListRow($model,'status', ['belum'=>'belum', 'selesai'=>'selesai'],array('class'=>'span5 form-control','maxlength'=>7)); ?>

		<?php echo $form->dropDownListRow($model,'status_selesai', ['under'=>'under', 'over'=>'over'], array('class'=>'span5 form-control','maxlength'=>5)); ?>
	<?php else: ?>
		<?php echo $form->dropDownListRow($model,'status', ['belum'=>'belum', 'selesai'=>'selesai'],array('class'=>'span5 form-control', 'readonly'=>'readonly')); ?>

		<?php echo $form->dropDownListRow($model,'status_selesai', ['under'=>'under', 'over'=>'over'], array('class'=>'span5 form-control', 'readonly'=>'readonly')); ?>
	<?php endif ?>
