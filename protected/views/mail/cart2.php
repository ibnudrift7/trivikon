                            ...
                            <tbody>
                                <tr style="margin:0;padding:0">
                                    <td style="margin:0;padding:0">
                                        ...
                                        <p style="font-weight:normal;font-size:14px;line-height:1.6;margin:0 0 20px;padding:0">Anda dapat memantau status pesanan dengan mengakses halaman Status Pemesanan pada akun <span class="lG">Stumble Upon</span> Anda.</p>
                                                    ...
                                                    <table bgcolor="transparent" style="width:100%;max-width:100%;border-collapse:collapse;border-spacing:0;background-color:transparent;margin:5px 0;padding:0">
                                                        <tbody style="margin:0;padding:0">
                                                            <tr style="margin:0;padding:0">
                                                                ...
                                                                <td align="right" valign="top" style="text-align:right;font-size:13px;vertical-align:top;line-height:18px;margin:0;padding:0 10px 0 0"><?php echo Cart::money($subTotal, 0) ?>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table bgcolor="transparent" style="width:100%;max-width:100%;border-collapse:collapse;border-spacing:0;background-color:transparent;margin:5px 0;padding:0">
                                                        <tbody style="margin:0;padding:0">
                                                            <tr style="margin:0;padding:0">
                                                                ...
                                                                <td align="right" valign="top" style="text-align:right;font-size:13px;vertical-align:top;line-height:18px;margin:0;padding:0 10px 0 0"><?php echo Cart::money($modelOrder->total+$modelOrder->delivery_price, 0) ?>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                ...
                                <tr style="margin:0;padding:0">
                                    <td valign="top" style="margin:0;padding:0 10px 0 0;width:75%">
                                        ...
                                        <span style="font-size:12px;margin-bottom:6px;display:inline-block">
                                            <b><?php echo Yii::t('mail', 'Hubungi') ?> <span class="lG">Stumble Upon</span></b> <br>
                                    ...
                                    */ ?>
                                    <td valign="middle" style="margin:0;padding:0;width:53%">
                                        ...
                                        <p style="color:#91908e;font-size:10px;line-height:150%;font-weight:normal;margin:0px;padding:0px"><?php echo Yii::t('mail', 'Jika butuh bantuan, gunakan halaman') ?> <a target="_blank" style="color:#0f990f;text-decoration:none;margin:0;padding:0" href="<?php echo $url.CHtml::normalizeUrl(array('/home/pcontact')); ?>"><?php echo Yii::t('mail', 'Kontak Kami') ?></a>.<br style="margin:0;padding:0"><?php echo date('Y') ?> &copy;
                                            ...
                                            <span class="lG">Stumble Upon</span></p>
                                    </td>
                                    <td valign="middle" style="width:40%">

                                        <div style="text-align:right"><img alt="Stumble Upon" style="max-width: 120px;" src="<?php echo $baseUrl ?>/asset/images/lgo_stumble-upon_header.png">
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
