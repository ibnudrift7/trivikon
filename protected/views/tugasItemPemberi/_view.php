<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('date_start_user')); ?>:</b>
	<?php echo CHtml::encode($data->date_start_user); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('date_selesai_user')); ?>:</b>
	<?php echo CHtml::encode($data->date_selesai_user); ?>
	<br />
