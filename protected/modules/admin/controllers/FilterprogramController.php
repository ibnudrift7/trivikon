...
class FilterprogramController extends ControllerAdmin
{
	public $type = 'filterprogram';
	/**
	...
	public function actionCreate()
	{
		...
		$nestedCategory = PrdCategory::model()->nested($dataNestedCategory['data'], 'filterprogram');
	...
	public function actionIndex()
	{
		...
		if (isset($_POST['PrdCategoryDescription'])) {
			...
			if($categoryModel->validate() AND $valid){
				...
				try
				{
					$categoryModel->type = 'filterprogram';
					$categoryModel->save();
