...
class FilterliterasiController extends ControllerAdmin
{
	public $type = 'filterliterasi';
	/**
	...
	public function actionCreate()
	{
		...
		$nestedCategory = PrdCategory::model()->nested($dataNestedCategory['data'], 'filterliterasi');
	...
	public function actionIndex()
	{
		...
		if (isset($_POST['PrdCategoryDescription'])) {
			...
			if($categoryModel->validate() AND $valid){
				...
				try
				{
					$categoryModel->type = 'filterliterasi';
					$categoryModel->save();
