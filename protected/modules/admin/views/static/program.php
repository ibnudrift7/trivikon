	...
	<div class="span12">
		...
		<div class="widgetcontent">
			...
			<div class="divider5"></div>
				...
				<p class="help-block">NOTE: Picture  landscape with min width 555 px, Larger image will be automatically cropped.</p>
