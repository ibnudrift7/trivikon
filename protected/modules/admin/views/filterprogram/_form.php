...
<div class="widgetcontent">
	...
	'hint'=>'<b>Note:</b> Gambar tidak di resize, jadi pastikan gambar sudah fix, rata2 tinggi 80px', 'style'=>"width: 100%")); ?>
	<?php if ($model->scenario == 'update'): ?>
	<div class="control-group">
		<label class="control-label">&nbsp;</label>
		<div class="controls">
			<img src="<?php echo Yii::app()->baseUrl.ImageHelper::thumb(500,500, '/images/category/'.$model->image , array('method' => 'adaptiveResize', 'quality' => '90')) ?>"/>
		</div>
	</div>
	<?php endif; ?>
	<br>
