<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<div class="widget">
		...
		<div class="widgetcontent">
			...
			<div class="row-fluid">
				<div class="span6">
					<?php echo $form->textFieldRow($model,'data[url_spotify]',array('class'=>'input-block-level', 'placeholder'=>'URL Soundcloud')); ?>
				</div>
				<div class="span6">
					<?php echo $form->textFieldRow($model,'data[url_twitter]',array('class'=>'input-block-level', 'placeholder'=>'URL Youtube')); ?>
				</div>
			</div>
