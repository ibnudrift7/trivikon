...
$this->menu=array(
	// array('label'=>'Add Literasi', 'icon'=>'th-list','url'=>array('create', 'parent'=>$_GET['parent']), 'visible'=>($_GET['parent'] == '' || $_GET['parent'] == 0) ? true : false),
	array('label'=>'Add Literasi Category', 'icon'=>'plus-sign','url'=>array('create', 'parent'=>$_GET['parent'])),
);
?>
...
<div class="row-fluid">
	<div class="span8">
		<div class="widgetbox block-rightcontent">                        
		    <div class="headtitle">
		        <h4 class="widgettitle">Data Literasi</h4>
		    </div>
