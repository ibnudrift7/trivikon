...
<?php $this->endWidget(); ?>
				...
				<div class="row-fluid">
					...
					<div class="span9">
						<h3 class="title-product"><?php echo ucwords($value->description->name) ?></h3>
						<div class="row-fluid">
							<div class="span5">
								<p><?php echo substr(strip_tags($value->description->desc), 0, 200) ?></p>
							...
							<div class="span7">
                            	...
                            	<a data-id="<?php echo $value->terbaru ?>" href="<?php echo CHtml::normalizeUrl(array('setStatus', 'id'=>$value->id, 'type'=>'terbaru')); ?>" class="btn btn-small btn-primary btn-terbaru">Best Seller <i class="fa fa-check-square-o"></i></a>
	...
	<script type="text/javascript">
		jQuery(function ( $ ) {
			...
			$('.btn-terbaru').setStatusAjax({
				content: 'Best Seller <i class="fa fa-square-o">',
				contentOK: 'Best Seller <i class="fa fa-check-square-o">',
				class: 'btn-ok',
				classOK: 'btn-primary',
			})
