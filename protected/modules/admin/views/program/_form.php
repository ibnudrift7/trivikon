		...
		<div class="widgetcontent">
			...
			<div class="controls">
				<select id="Literasi_topik_id" name="Literasi[topik_id]" class="input-block-level">
					<?php 
					$dataCategory = (PrdCategory::model()->categoryTree('filterprogram', $this->languageID));
					?>
			...
			*/ ?>
			...
			'hint'=>'<b>Note:</b> Ukuran gambar adalah 650 x 400px. Gambar yang lebih besar akan ter-crop otomatis, tolong upload foto ukuran horizontal')); ?>
			<?php if ($model->scenario == 'update'): ?>
			<div class="control-group">
				<label class="control-label">&nbsp;</label>
				<div class="controls">
				<img src="<?php echo Yii::app()->baseUrl.ImageHelper::thumb(650,400, '/images/blog/'.$model->image2 , array('method' => 'adaptiveResize', 'quality' => '90')) ?>"/>
				</div>
			</div>
			<?php endif; ?>
