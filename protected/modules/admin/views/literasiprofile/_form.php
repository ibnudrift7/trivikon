		...
		<div class="widgetcontent">
			...
			<div class="controls">
				<select id="Blog_topik_id" name="Blog[topik_id]" class="input-block-level">
					...
					?>
					<option value="">---- Choose Literasi ----</option>
					<?php foreach ($dataLiterasi as $key => $value): ?>
			...
			'hint'=>'<b>Note:</b> Ukuran gambar adalah 115 x 115px. Gambar yang lebih besar akan ter-crop otomatis, tolong upload foto ukuran horizontal')); ?>
			<?php if ($model->scenario == 'update'): ?>
			<div class="control-group">
				<label class="control-label">&nbsp;</label>
				<div class="controls">
				<img src="<?php echo Yii::app()->baseUrl.ImageHelper::thumb(115,115, '/images/blog/'.$model->image , array('method' => 'adaptiveResize', 'quality' => '90')) ?>"/>
				</div>
			</div>
			<?php endif; ?>
