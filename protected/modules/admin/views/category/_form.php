...
<div class="widgetcontent">
	...
	'hint'=>'<b>Note:</b> Ukuran gambar adalah 387 x 172px. Gambar yang lebih besar akan ter-crop otomatis', 'style'=>"width: 100%")); ?>
	<?php if ($model->scenario == 'update'): ?>
	<div class="control-group">
		<label class="control-label">&nbsp;</label>
		<div class="controls">
			<img style="background-color: #999;" src="<?php echo Yii::app()->baseUrl.ImageHelper::thumb(387,172, '/images/category/'.$model->image , array('method' => 'adaptiveResize', 'quality' => '90')) ?>"/>
		</div>
	</div>
	<?php endif; ?>
	<br>
	...
	'hint'=>'<b>Note:</b> Ukuran gambar adalah 1600 x 400px. Gambar yang lebih besar akan ter-crop otomatis', 'style'=>"width: 100%")); ?>
	<?php if ($model->scenario == 'update'): ?>
	<div class="control-group">
		<label class="control-label">&nbsp;</label>
		<div class="controls">
			<img style="background-color: #999;" src="<?php echo Yii::app()->baseUrl.ImageHelper::thumb(1600,400, '/images/category/'.$model->image2 , array('method' => 'adaptiveResize', 'quality' => '90')) ?>"/>
		</div>
	</div>
	<?php endif; ?>
	<br>
