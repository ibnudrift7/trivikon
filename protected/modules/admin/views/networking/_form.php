...
<div class="widget">
<h4 class="widgettitle">Data Networking</h4>
<div class="widgetcontent">
	...
	<div class="row-fluid">
		...
		<div class="span4">
			...
			'hint'=>'<b>Note:</b> Image size is 100 x 100px. Larger image will be automatically cropped.', 'style'=>"width: 100%")); ?>
			<?php if ($model->scenario == 'update'): ?>
			<img src="<?php echo Yii::app()->baseUrl.ImageHelper::thumb(100,100, '/images/networking/'.$model->image , array('method' => 'adaptiveResize', 'quality' => '90')) ?>"/>
			<?php endif; ?>
			<br>
		</div>
	</div>
